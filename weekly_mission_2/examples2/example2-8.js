...
class Toolbox {
    static getMostUsefulTools(){ //lo que hace es algo asi como los valores default pero con metodo de una clase, de esta manera no tenemos que instanciar/crear la clase, ya que tiene valor predefinidos
        return ["Command line", "git", "Text Editor"] //metodos de la clase
    }
}
...
console.log(Toolbox); //solo nos dira que es una clase con el nombre de toolbox
